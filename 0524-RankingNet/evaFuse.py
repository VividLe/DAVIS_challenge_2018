...
def main():
    ...
    sep_cate_rp = '/disk5/yangle/DAVIS/result/mask/maskrcnn_Caffe2/SegMaskSep/maskrcnn-TF/'
    res_rp = '/disk5/yangle/DAVIS/result/mask/step1_select/maskrcnn-TF/'
